...
const GuestInvitationDetails: React.FC<GuestInvitationDetailsProps> = ({ visitId, guestProfile }) => {
  ...
  return (
    <>
      <Widget
        title={t('page.guestInvitations.invitationDetails')}
        showContent={!!guestProfile}
        hasContent={!!guestProfile}
        infoText={t('page.guestInvitations.invitationNotFound')}
      >
        <>
          ...
          {!guestProfile?.guestDetails.actualEntry && (
